...
app.get("/init-register", async (req, res) => {
  ...
  console.log("options in init register", options);
...
app.post("/verify-register", async (req, res) => {
  ...
  if (verification.verified) {
    ...
    createUser(regInfo.userId, regInfo.email, {
      ...
      publicKey: verification.registrationInfo.credentialPublicKey, // For future signature verification
      ...
      transport: req.body.transports, // e.g., ["internal", "usb", "ble"]
    });
